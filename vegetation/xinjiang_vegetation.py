...
json_path = '新疆维吾尔自治区.json'  # 替换为你的本地 GeoJSON 文件路径
import os
...
tif_path_elev = 'evi/EVI_xinjiang_2023.tif'  # Elevation 文件路径
...
tif_path_ndvi = 'nvdi/NDVI_xinjiang_2023.tif'  # NDVI 文件路径
